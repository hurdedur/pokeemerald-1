const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_VENONAT]    = {{EVO_LEVEL, 27, SPECIES_VENOMOTH}},
    ...
    [SPECIES_GRIMER]     = {{EVO_LEVEL, 33, SPECIES_MUK}},
    ...
    [SPECIES_HORSEA]     = {{EVO_LEVEL, 27, SPECIES_SEADRA}},
    [SPECIES_SEADRA]     = {{EVO_LEVEL, 42, SPECIES_KINGDRA}},
    [SPECIES_GOLDEEN]    = {{EVO_LEVEL, 22, SPECIES_SEAKING}},
    [SPECIES_STARYU]     = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_STARMIE}},
    [SPECIES_SCYTHER]    = {{EVO_LEVEL, 37, SPECIES_SCIZOR}},
    ...
    [SPECIES_PINECO]     = {{EVO_LEVEL, 29, SPECIES_FORRETRESS}},
    ...
    [SPECIES_BARBOACH]   = {{EVO_LEVEL, 26, SPECIES_WHISCASH}},
    ...
    [SPECIES_CACNEA]     = {{EVO_LEVEL, 27, SPECIES_CACTURNE}},
    ...
    [SPECIES_LOUDRED]    = {{EVO_LEVEL, 38, SPECIES_EXPLOUD}},
    [SPECIES_CLAMPERL]   = {{EVO_LEVEL, 31, SPECIES_HUNTAIL},
                            {EVO_ITEM, ITEM_WATER_STONE, SPECIES_GOREBYSS}},
    [SPECIES_SHUPPET]    = {{EVO_LEVEL, 33, SPECIES_BANETTE}},

...
#define power arg2
    ...
    case PTS_REFLECT:
        ...
        if (IS_TYPE_PHYSICAL(gBattleMoves[gCurrentMove]) && power != 0 && tvPtr->side[defSide].reflectMonId != 0)
        {
    ...
    case PTS_LIGHT_SCREEN:
        ...
        if (IS_TYPE_SPECIAL(gBattleMoves[gCurrentMove]) && power != 0 && tvPtr->side[defSide].lightScreenMonId != 0)
        {
